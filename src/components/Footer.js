        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start gap-4 mt-4">
              <a 
                href="https://www.facebook.com/svbuilders" 
                target="_blank" 
              ...
              <a 
                href="https://www.twitter.com/svbuilders" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-dark-charcoal dark:text-creamy-white hover:text-primary transition-colors"
                aria-label="Twitter"
              ...
              <a 
                href="https://www.instagram.com/svbuilders" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-dark-charcoal dark:text-creamy-white hover:text-primary transition-colors"
              ...
              <a 
                href="https://www.linkedin.com/company/svbuilders" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-dark-charcoal dark:text-creamy-white hover:text-primary transition-colors"
                aria-label="LinkedIn"
              ...
              <a 
                href="https://www.youtube.com/@svbuilders" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-dark-charcoal dark:text-creamy-white hover:text-primary transition-colors"
                aria-label="YouTube"
          ...
          <div>
            <h3 className="text-lg font-bold font-display text-dark-charcoal dark:text-creamy-white mb-3">Our Projects in Bangalore</h3>
