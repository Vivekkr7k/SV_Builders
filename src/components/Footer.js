    ...
    <footer className="bg-creamy-white dark:bg-dark-charcoal/50 py-12 px-4 sm:px-10 mt-20">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-bold font-display text-dark-charcoal dark:text-creamy-white mb-3">SV Builders and Developers</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link className="text-sm text-dark-charcoal/70 dark:text-creamy-white/70 hover:text-primary transition-colors" to="/projects" title="View our residential projects in Bangalore">Our Projects</Link></li>
              <li><Link className="text-sm text-dark-charcoal/70 dark:text-creamy-white/70 hover:text-primary transition-colors" to="/about" title="Learn about SV Builders and Developers">About Us</Link></li>
              <li><Link className="text-sm text-dark-charcoal/70 dark:text-creamy-white/70 hover:text-primary transition-colors" to="/services" title="Our construction services">Services</Link></li>
              <li><Link className="text-sm text-dark-charcoal/70 dark:text-creamy-white/70 hover:text-primary transition-colors" to="/blog" title="Read our latest blog posts">Blog</Link></li>
              <li><Link className="text-sm text-dark-charcoal/70 dark:text-creamy-white/70 hover:text-primary transition-colors" to="/privacy-policy" title="Privacy Policy">Privacy Policy</Link></li>
              <li><Link className="text-sm text-dark-charcoal/70 dark:text-creamy-white/70 hover:text-primary transition-colors" to="/disclaimer" title="Disclaimer">Disclaimer</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-light-taupe/50 dark:border-creamy-white/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-dark-charcoal/70 dark:text-creamy-white/70">
            <p>© {new Date().getFullYear()} SV Builders and Developers. All Rights Reserved.</p>
            <div className="flex gap-4">
              <Link to="/privacy-policy" className="hover:text-primary transition-colors" title="Privacy Policy">Privacy Policy</Link>
              <span>|</span>
              <Link to="/disclaimer" className="hover:text-primary transition-colors" title="Disclaimer">Disclaimer</Link>
              <span>|</span>
              <Link to="/terms" className="hover:text-primary transition-colors" title="Terms & Conditions">Terms & Conditions</Link>
            </div>
          </div>
        </div>
      </div>
